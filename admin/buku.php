...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="container-fluid">
    ...
    if(isset($_GET['tgl_awl'])){
      $awl=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['tgl_awl']);
      ...
      $fin=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct inv, period, remark from finance order by date desc limit $start, $per_hal");
      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
          <tr>
            ...
            $sumi=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(if(inv='$invo', debit, 0)) as dbt, SUM(if(inv='$invo', credit, 0)) as krd from finance");
              while($s=mysqli_fetch_array($sumi)){
              $amon = $s['krd'] - $s['dbt'];
            ?>
            <td align="center"><?php echo number_format($data,0,'',',') ?></td>
