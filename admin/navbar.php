...
<html lang="en">
  ...
  <body class="bg-light">
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/bugelan"><img src="../assets/logo/logo_white.png"  width="40" height="35"></a>
    ...
    <div class="container-fluid">
      ...
      ?> 
      <div class="row <?php if(substr($url[3],0,10) === 'nilai?nisn' || substr($url[3],0,10) === 'absensi?go'){ echo 'd-none'; } ?>">
