...
$pdf->Cell(0,0.7,'REKAP ABSENSI GURU',0,1,'C');
...
$pdf->Cell(2.5, 0.7, 'NIG', 1, 0, 'C');
$pdf->Cell(5, 0.7, 'Nama Guru', 1, 0, 'C');
$pdf->Cell(1, 0.7, 'Ket', 1, 0, 'C');
$pdf->Cell(3, 0.7, 'Note', 1, 1, 'C');

$no=1;
$query=mysqli_query($conn, "SELECT * from absenguru where date between '$awl' and '$ahr' order by date");
